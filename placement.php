...
$stipend=$_POST['stipend'];
  ...
  $INSERT = "insert into student5(ID,placement,cname,ctc,sem,campus,icname,stipend) values ('{$s_id}','{$placement}','{$cname}','{$ctc}','{$sem}','{$campus}','{$icname}','{$stipend}')";
    ...
    if(!empty($icname1)){
        for($i = 0; $i < count($icname1); $i++){
            if(!empty($icname1[$i])){
               ...
               $sems=$sem1[$i];
               $dess=$des[$i];  
        $insertCourse = "INSERT INTO student5(ID,icname1,stipend1,mentor,sem1,des) 
        VALUES ('{$s_id}','{$icnames}','{$stipends}','{$mentors}','{$sems}','{$dess}')";
...
<div class="container">
    <form name="addem" class="form-horizontal" action="placement.php" method="post">
        ...
        <fieldset>
            ...
            <label>Placements Done?<font color="red"><sup>*</sup></font></label><input type="radio" name="placement" value="Y" onclick="document.getElementById('on').disabled = false; document.getElementById('off').disabled = true;">Yes<input type="radio" name="placement" value="N"  onclick="document.getElementById('on').disabled = true; document.getElementById('off').disabled = false;">No<br><br>
            <fieldset id="on">
            <label>Company Name:<font color="red"><sup>*</sup></font><input type="text" class="form-control" id="on" name="cname" required></label><br>
            <label>Cost to Company (CTC):<font color="red"><sup>*</sup></font><input type="text" class="form-control" id="on" name="ctc" required></label><br>
            <label>Semester in which placement is done:<font color="red"><sup>*</sup></font><input type="number" class="form-control" min="7" max="8" step="1" name="sem" required></label><br>
                <label>Mode of Placement:<font color="red"><sup>*</sup></font></label>&nbsp;&nbsp;&nbsp;<input type="radio" id="custom" name="campus" value="oncampus" onclick="document.getElementById('custom2').disabled = true; document.getElementById('charstype2').disabled = false;"><label>On-Campus</label>&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" id="custom" name="campus" value="offcampus" onclick="document.getElementById('custom2').disabled = false; document.getElementById('charstype2').disabled = true;"><label>Off-Campus</label>
                <br><br>
                <fieldset>
                <legend>6M Internship(8th Sem):</legend>
                    <label>Company Name:<font color="red"><sup>*</sup></font><input type="text" class="form-control" id="custom2" name="icname"></label><br>
                    <label>Stipend(per month):<font color="red"><sup>*</sup></font><input type="text" class="form-control" name="stipend"></label><br>
                </fieldset>
            </fieldset>
        </fieldset>
                <br>
        ...
        <fieldset>
                <legend>Other Internships and Projects:</legend>
                    ...
                    <br>
                    <label>Company or Institute Name/Project Name:<font color="red"><sup>*</sup></font><input type="text" class="form-control" style="width: 200px;" name="icname1[]"></label><br>
                    <label>Stipend(per month):<font color="red"><sup>*</sup></font><input type="text" class="form-control" style="width: 200px;" name="stipend1[]"></label><br>
                    <label>Guide or Mentor Name:<input type="text" class="form-control" style="width: 200px;" name="mentor[]" ></label><br>
                    <label>Duration(in months):<font color="red"><sup>*</sup></font><input type="number" style="width: 200px;" class="form-control" min="1" max="6" step="1" name="sem1[]" ></label><br>
                    <label>Description:</label><font color="red"><sup>*</sup></font><textarea cols="5" rows="3" class="form-control" name="des[]" placeholder="Write description here..."></textarea>
        </fieldset>
            </div>
        </div>
        <br>
