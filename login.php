...
$query = mysqli_query($conn,"select * from student1 where password='$password' AND username='$username'");
		...
		<div class="container-login100" style="background-image: url('images/1.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form action="login.php" method="post" class="login100-form validate-form p-b-33 p-t-5">
					<div id="l2"><?php if($_POST['submit']){ if ($rows == 1) {
$_SESSION['username']=$username; // Initializing Session
header("Location:studentsearch.php"); // Redirecting To Other Page
} else {
